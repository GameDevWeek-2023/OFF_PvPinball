...
{
    const string privateCode = "H160w3SeOEucvB1lAohZ7wtQH8QK8NbUyFl_MjLbyjjg";  //Key to Upload New Info
    const string publicCode = "6415ec948f40bb109ce56551";   //Key to download
    ...
    IEnumerator DatabaseDownload()
    {
        ...
        WWW www = new WWW(webURL + publicCode + "/pipe/0/20"); //Gets top 10
        print(www);
